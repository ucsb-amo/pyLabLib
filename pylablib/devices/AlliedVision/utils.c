...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "pylablib.devices.AlliedVision.utils",
        "sources": [
            "C:\\Temp\\cython\\pylablib\\devices\\AlliedVision\\utils.pyx"
        ]
    },
    "module_name": "pylablib.devices.AlliedVision.utils"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pylablib__devices__AlliedVision__utils
#define __PYX_HAVE_API__pylablib__devices__AlliedVision__utils
/* Early includes */
#include <string.h>
#ifdef _OPENMP
#include <omp.h>
...
/* "pylablib/devices/AlliedVision/utils.pyx":4
...
*/
typedef unsigned long __pyx_t_8pylablib_7devices_12AlliedVision_5utils_uint32_t;

/* "pylablib/devices/AlliedVision/utils.pyx":5
 * 
 * ctypedef unsigned long uint32_t
 * ctypedef unsigned long long uint64_t             # <<<<<<<<<<<<<<
 * ctypedef int (*pVmbCaptureFrameQueue)(void *handle, void *frame, void *callback) noexcept nogil
 * 
*/
typedef unsigned PY_LONG_LONG __pyx_t_8pylablib_7devices_12AlliedVision_5utils_uint64_t;
/* #### Code section: complex_type_declarations ### */
/* #### Code section: type_declarations ### */

/*--- Type declarations ---*/

/* "pylablib/devices/AlliedVision/utils.pyx":6
 * ctypedef unsigned long uint32_t
 * ctypedef unsigned long long uint64_t
 * ctypedef int (*pVmbCaptureFrameQueue)(void *handle, void *frame, void *callback) noexcept nogil             # <<<<<<<<<<<<<<
 * 
...
*/
typedef int (*__pyx_t_8pylablib_7devices_12AlliedVision_5utils_pVmbCaptureFrameQueue)(void *, void *, void *);
...
/* Module declarations from "pylablib.devices.AlliedVision.utils" */
static void __pyx_f_8pylablib_7devices_12AlliedVision_5utils_ccallback(void *, void *, char *); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "pylablib.devices.AlliedVision.utils"
extern int __pyx_module_is_main_pylablib__devices__AlliedVision__utils;
int __pyx_module_is_main_pylablib__devices__AlliedVision__utils = 0;

/* Implementation of "pylablib.devices.AlliedVision.utils" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_8pylablib_7devices_12AlliedVision_5utils_get_callback(CYTHON_UNUSED PyObject *__pyx_self); /* proto */
...
#define __pyx_n_u_pylablib_devices_AlliedVision_ut __pyx_string_tab[12]
...
/* "pylablib/devices/AlliedVision/utils.pyx":8
 * ctypedef int (*pVmbCaptureFrameQueue)(void *handle, void *frame, void *callback) noexcept nogil
 * 
 * @cython.cdivision(True)             # <<<<<<<<<<<<<<
...
static void __pyx_f_8pylablib_7devices_12AlliedVision_5utils_ccallback(void *__pyx_v_camhandle, CYTHON_UNUSED void *__pyx_v_strmhandle, char *__pyx_v_frame) {
  char *__pyx_v_fbuff;
  size_t *__pyx_v_context;
  size_t *__pyx_v_funcs;
  size_t *__pyx_v_ctl;
  size_t *__pyx_v_buff;
  size_t *__pyx_v_stat;
  __pyx_t_8pylablib_7devices_12AlliedVision_5utils_pVmbCaptureFrameQueue __pyx_v_VmbCaptureFrameQueue;
  void *__pyx_v_callback;
  int __pyx_v_err;
  size_t __pyx_v_idx;
  size_t *__pyx_v_pfibuff;
  long __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;

  /* "pylablib/devices/AlliedVision/utils.pyx":10
 * @cython.cdivision(True)
 * cdef void ccallback(void *camhandle, void *strmhandle, char *frame) noexcept nogil:
 *     cdef char *fbuff=(<char**>(frame+0))[0]             # <<<<<<<<<<<<<<
...
*/
  __pyx_v_fbuff = (((char **)(__pyx_v_frame + 0))[0]);

  /* "pylablib/devices/AlliedVision/utils.pyx":11
 * cdef void ccallback(void *camhandle, void *strmhandle, char *frame) noexcept nogil:
 *     cdef char *fbuff=(<char**>(frame+0))[0]
 *     cdef size_t *context=(<size_t**>(frame+16))[0]             # <<<<<<<<<<<<<<
 *     cdef size_t *funcs=<size_t*>(context[0])
...
*/
  __pyx_v_context = (((size_t **)(__pyx_v_frame + 16))[0]);

  /* "pylablib/devices/AlliedVision/utils.pyx":12
 *     cdef char *fbuff=(<char**>(frame+0))[0]
 *     cdef size_t *context=(<size_t**>(frame+16))[0]
 *     cdef size_t *funcs=<size_t*>(context[0])             # <<<<<<<<<<<<<<
 *     cdef size_t *ctl=<size_t*>(context[1])
...
*/
  __pyx_v_funcs = ((size_t *)(__pyx_v_context[0]));

  /* "pylablib/devices/AlliedVision/utils.pyx":13
 *     cdef size_t *context=(<size_t**>(frame+16))[0]
 *     cdef size_t *funcs=<size_t*>(context[0])
 *     cdef size_t *ctl=<size_t*>(context[1])             # <<<<<<<<<<<<<<
 *     cdef size_t *buff=<size_t*>(context[2])
...
*/
  __pyx_v_ctl = ((size_t *)(__pyx_v_context[1]));

  /* "pylablib/devices/AlliedVision/utils.pyx":14
 *     cdef size_t *funcs=<size_t*>(context[0])
 *     cdef size_t *ctl=<size_t*>(context[1])
 *     cdef size_t *buff=<size_t*>(context[2])             # <<<<<<<<<<<<<<
 *     cdef size_t *stat=<size_t*>(context[3])
 *     stat[0]+=1
*/
  __pyx_v_buff = ((size_t *)(__pyx_v_context[2]));

  /* "pylablib/devices/AlliedVision/utils.pyx":15
 *     cdef size_t *ctl=<size_t*>(context[1])
 *     cdef size_t *buff=<size_t*>(context[2])
 *     cdef size_t *stat=<size_t*>(context[3])             # <<<<<<<<<<<<<<
 *     stat[0]+=1
...
*/
  __pyx_v_stat = ((size_t *)(__pyx_v_context[3]));

  /* "pylablib/devices/AlliedVision/utils.pyx":16
 *     cdef size_t *buff=<size_t*>(context[2])
 *     cdef size_t *stat=<size_t*>(context[3])
 *     stat[0]+=1             # <<<<<<<<<<<<<<
 *     cdef pVmbCaptureFrameQueue VmbCaptureFrameQueue=<pVmbCaptureFrameQueue>(funcs[0])
...
*/
  __pyx_t_1 = 0;
  (__pyx_v_stat[__pyx_t_1]) = ((__pyx_v_stat[__pyx_t_1]) + 1);

  /* "pylablib/devices/AlliedVision/utils.pyx":17
 *     cdef size_t *stat=<size_t*>(context[3])
 *     stat[0]+=1
 *     cdef pVmbCaptureFrameQueue VmbCaptureFrameQueue=<pVmbCaptureFrameQueue>(funcs[0])             # <<<<<<<<<<<<<<
 *     cdef void *callback=<void*>(funcs[1])
...
*/
  __pyx_v_VmbCaptureFrameQueue = ((__pyx_t_8pylablib_7devices_12AlliedVision_5utils_pVmbCaptureFrameQueue)(__pyx_v_funcs[0]));

  /* "pylablib/devices/AlliedVision/utils.pyx":18
 *     stat[0]+=1
 *     cdef pVmbCaptureFrameQueue VmbCaptureFrameQueue=<pVmbCaptureFrameQueue>(funcs[0])
 *     cdef void *callback=<void*>(funcs[1])             # <<<<<<<<<<<<<<
 *     if (not ctl[0]) or (ctl[2]!=0):
 *         return
*/
  __pyx_v_callback = ((void *)(__pyx_v_funcs[1]));

  /* "pylablib/devices/AlliedVision/utils.pyx":19
 *     cdef pVmbCaptureFrameQueue VmbCaptureFrameQueue=<pVmbCaptureFrameQueue>(funcs[0])
 *     cdef void *callback=<void*>(funcs[1])
 *     if (not ctl[0]) or (ctl[2]!=0):             # <<<<<<<<<<<<<<
 *         return
 *     cdef int err=0
*/
  __pyx_t_3 = (!((__pyx_v_ctl[0]) != 0));
  if (!__pyx_t_3) {
  } else {
    __pyx_t_2 = __pyx_t_3;
    goto __pyx_L4_bool_binop_done;
  }
  __pyx_t_3 = ((__pyx_v_ctl[2]) != 0);
  __pyx_t_2 = __pyx_t_3;
  __pyx_L4_bool_binop_done:;
  if (__pyx_t_2) {

    /* "pylablib/devices/AlliedVision/utils.pyx":20
 *     cdef void *callback=<void*>(funcs[1])
 *     if (not ctl[0]) or (ctl[2]!=0):
 *         return             # <<<<<<<<<<<<<<
 *     cdef int err=0
...
*/
  ...
  /* "pylablib/devices/AlliedVision/utils.pyx":21
 *     if (not ctl[0]) or (ctl[2]!=0):
 *         return
 *     cdef int err=0             # <<<<<<<<<<<<<<
 *     cdef size_t idx=<size_t>(fbuff-buff[3])/buff[1]
...
*/
  ...
  /* "pylablib/devices/AlliedVision/utils.pyx":22
 *         return
 *     cdef int err=0
 *     cdef size_t idx=<size_t>(fbuff-buff[3])/buff[1]             # <<<<<<<<<<<<<<
 *     cdef size_t *pfibuff=<size_t*>(buff[4]+idx*buff[2])
 *     if ctl[1]:
*/
  __pyx_v_idx = (((size_t)(__pyx_v_fbuff - (__pyx_v_buff[3]))) / (__pyx_v_buff[1]));

  /* "pylablib/devices/AlliedVision/utils.pyx":23
 *     cdef int err=0
 *     cdef size_t idx=<size_t>(fbuff-buff[3])/buff[1]
 *     cdef size_t *pfibuff=<size_t*>(buff[4]+idx*buff[2])             # <<<<<<<<<<<<<<
 *     if ctl[1]:
...
*/
  __pyx_v_pfibuff = ((size_t *)((__pyx_v_buff[4]) + (__pyx_v_idx * (__pyx_v_buff[2]))));

  /* "pylablib/devices/AlliedVision/utils.pyx":24
 *     cdef size_t idx=<size_t>(fbuff-buff[3])/buff[1]
 *     cdef size_t *pfibuff=<size_t*>(buff[4]+idx*buff[2])
 *     if ctl[1]:             # <<<<<<<<<<<<<<
 *         pfibuff[0]=(<size_t*>(frame+56))[0]
...
*/
  __pyx_t_2 = ((__pyx_v_ctl[1]) != 0);
  if (__pyx_t_2) {

    /* "pylablib/devices/AlliedVision/utils.pyx":25
 *     cdef size_t *pfibuff=<size_t*>(buff[4]+idx*buff[2])
 *     if ctl[1]:
 *         pfibuff[0]=(<size_t*>(frame+56))[0]             # <<<<<<<<<<<<<<
 *         pfibuff[1]=(<size_t*>(frame+64))[0]
...
*/
    (__pyx_v_pfibuff[0]) = (((size_t *)(__pyx_v_frame + 56))[0]);

    /* "pylablib/devices/AlliedVision/utils.pyx":26
 *     if ctl[1]:
 *         pfibuff[0]=(<size_t*>(frame+56))[0]
 *         pfibuff[1]=(<size_t*>(frame+64))[0]             # <<<<<<<<<<<<<<
 *         pfibuff[2]=(<uint32_t*>(frame+88))[0]
...
*/
    (__pyx_v_pfibuff[1]) = (((size_t *)(__pyx_v_frame + 64))[0]);

    /* "pylablib/devices/AlliedVision/utils.pyx":27
 *         pfibuff[0]=(<size_t*>(frame+56))[0]
 *         pfibuff[1]=(<size_t*>(frame+64))[0]
 *         pfibuff[2]=(<uint32_t*>(frame+88))[0]             # <<<<<<<<<<<<<<
 *         pfibuff[3]=(<uint32_t*>(frame+92))[0]
...
*/
    (__pyx_v_pfibuff[2]) = (((__pyx_t_8pylablib_7devices_12AlliedVision_5utils_uint32_t *)(__pyx_v_frame + 88))[0]);

    /* "pylablib/devices/AlliedVision/utils.pyx":28
 *         pfibuff[1]=(<size_t*>(frame+64))[0]
 *         pfibuff[2]=(<uint32_t*>(frame+88))[0]
 *         pfibuff[3]=(<uint32_t*>(frame+92))[0]             # <<<<<<<<<<<<<<
 *         pfibuff[4]=(<uint32_t*>(frame+96))[0]
...
*/
    (__pyx_v_pfibuff[3]) = (((__pyx_t_8pylablib_7devices_12AlliedVision_5utils_uint32_t *)(__pyx_v_frame + 92))[0]);

    /* "pylablib/devices/AlliedVision/utils.pyx":29
 *         pfibuff[2]=(<uint32_t*>(frame+88))[0]
 *         pfibuff[3]=(<uint32_t*>(frame+92))[0]
 *         pfibuff[4]=(<uint32_t*>(frame+96))[0]             # <<<<<<<<<<<<<<
 *         pfibuff[5]=(<uint32_t*>(frame+100))[0]
...
*/
    (__pyx_v_pfibuff[4]) = (((__pyx_t_8pylablib_7devices_12AlliedVision_5utils_uint32_t *)(__pyx_v_frame + 96))[0]);

    /* "pylablib/devices/AlliedVision/utils.pyx":30
 *         pfibuff[3]=(<uint32_t*>(frame+92))[0]
 *         pfibuff[4]=(<uint32_t*>(frame+96))[0]
 *         pfibuff[5]=(<uint32_t*>(frame+100))[0]             # <<<<<<<<<<<<<<
 *     err=VmbCaptureFrameQueue(camhandle,frame,callback)
 *     if err:
*/
    (__pyx_v_pfibuff[5]) = (((__pyx_t_8pylablib_7devices_12AlliedVision_5utils_uint32_t *)(__pyx_v_frame + 0x64))[0]);
...
*/
  ...
  /* "pylablib/devices/AlliedVision/utils.pyx":31
 *         pfibuff[4]=(<uint32_t*>(frame+96))[0]
 *         pfibuff[5]=(<uint32_t*>(frame+100))[0]
 *     err=VmbCaptureFrameQueue(camhandle,frame,callback)             # <<<<<<<<<<<<<<
 *     if err:
 *         ctl[2]=err
*/
  __pyx_v_err = __pyx_v_VmbCaptureFrameQueue(__pyx_v_camhandle, __pyx_v_frame, __pyx_v_callback);

  /* "pylablib/devices/AlliedVision/utils.pyx":32
 *         pfibuff[5]=(<uint32_t*>(frame+100))[0]
 *     err=VmbCaptureFrameQueue(camhandle,frame,callback)
 *     if err:             # <<<<<<<<<<<<<<
 *         ctl[2]=err
...
*/
  ...
  if (__pyx_t_2) {
    ...
    /* "pylablib/devices/AlliedVision/utils.pyx":33
 *     err=VmbCaptureFrameQueue(camhandle,frame,callback)
 *     if err:
 *         ctl[2]=err             # <<<<<<<<<<<<<<
 *         return
...
*/
    ...
    /* "pylablib/devices/AlliedVision/utils.pyx":34
 *     if err:
 *         ctl[2]=err
 *         return             # <<<<<<<<<<<<<<
 * def get_callback():
...
/* "pylablib/devices/AlliedVision/utils.pyx":35
 *         ctl[2]=err
 *         return
 * def get_callback():             # <<<<<<<<<<<<<<
 *     return <size_t>(&ccallback)
...
/* Python wrapper */
static PyObject *__pyx_pw_8pylablib_7devices_12AlliedVision_5utils_1get_callback(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyMethodDef __pyx_mdef_8pylablib_7devices_12AlliedVision_5utils_1get_callback = {"get_callback", (PyCFunction)__pyx_pw_8pylablib_7devices_12AlliedVision_5utils_1get_callback, METH_NOARGS, 0};
static PyObject *__pyx_pw_8pylablib_7devices_12AlliedVision_5utils_1get_callback(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_callback (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_8pylablib_7devices_12AlliedVision_5utils_get_callback(__pyx_self);
...
static PyObject *__pyx_pf_8pylablib_7devices_12AlliedVision_5utils_get_callback(CYTHON_UNUSED PyObject *__pyx_self) {
  ...
  /* "pylablib/devices/AlliedVision/utils.pyx":36
 *         return
 * def get_callback():
 *     return <size_t>(&ccallback)             # <<<<<<<<<<<<<<
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyLong_FromSize_t(((size_t)(&__pyx_f_8pylablib_7devices_12AlliedVision_5utils_ccallback))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 36, __pyx_L1_error)
...
*/
  ...
  __Pyx_AddTraceback("pylablib.devices.AlliedVision.utils.get_callback", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
__Pyx_RefNannySetupContext("PyInit_utils", 0);
  ...
  if (__pyx_module_is_main_pylablib__devices__AlliedVision__utils) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pylablib.devices.AlliedVision.utils")) {
      if (unlikely((PyDict_SetItemString(modules, "pylablib.devices.AlliedVision.utils", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     return <size_t>(&ccallback)
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_8pylablib_7devices_12AlliedVision_5utils_1get_callback, 0, __pyx_mstate_global->__pyx_n_u_get_callback, NULL, __pyx_mstate_global->__pyx_n_u_pylablib_devices_AlliedVision_ut, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_get_callback, __pyx_t_2) < (0)) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "pylablib/devices/AlliedVision/utils.pyx":1
 * import cython             # <<<<<<<<<<<<<<
 * from libc.string cimport memcpy
 * 
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init pylablib.devices.AlliedVision.utils", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init pylablib.devices.AlliedVision.utils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{9},{20},{18},{18},{8},{12},{13},{5},{8},{10},{8},{35},{12},{12},{10},{8},{6},{11}};
    #if (CYTHON_COMPRESS_STRINGS) == 3 && __PYX_LIMITED_VERSION_HEX >= 0x030e0000 /* compression: zstd (171 bytes) */
const char* const cstring = "(\265/\375 \340\025\005\000\322K#\035\240\253\003\377\377?\3169\330\334\266\346\333\357\373\202\255\354\336Y\253\035\342\205^\177\325o1\ngp\304&\004\035\240I\235\374\256\277\245\366\337<\337\243N\253l\225?\277Y\375C\234V.\343\3502\033\203T\270\227:C\263\334<\316\250_\245\027\377_y:\223\364\377q\237\364KI{/\227\371\301\267B?\214\363\371#\370\032\205\317\352\307\275\306e(5n\317\311\232\3400-\214\231|\217.\215)\362\206{`Y\362c\0315H\336\236E\006\000^e-uJ\213\314\205W\325\0007/\023p\353";
...
const char* const cstring = "x\332=\216\261n\002A\014D\205D\307\277l\237\n!QG\204\202v\344\363\371\"+\276]\300\273'\256\243\244\344\363\3629q8\t\027\343'kF\236m\253j\236\316\363\r8\204\034\346\275r\305\247\334\352Q\006\3629\263\226\304\345Z\302\230\305\331B\241\031\365J,\035\361\0170\264\314\300\267T0\231\275n\352xg\264\312\350\300H\221\212\031K\337L\376)\323\030\373<\033u\246]\352eR\026O;3\225\376\244\256%\247W=\340\322\310\026;\340\361h\341\240>J6\253@\025\017\235\310\232\370}\365\273\336<>\236\273\347\327\037kOY]";
...
const char* const bytes = "?utils.pyx__Pyx_PyDict_NextRefasyncio.coroutinescline_in_traceback__func__get_callback_is_coroutineitems__main____module____name__pylablib.devices.AlliedVision.utils__qualname____set_name__setdefault__test__values\200\001\330\004\013\2109\220A\220Q";
    PyObject *data = NULL;
